...
def test_from_wide_df():
    ...
    extra_wide_df = {
        "sh_1": [1.1, 2.2, 3.3],
        "sh_2": [11.1, 22.2, 33.3],
        "1_it_1": [0.01, 0.02, 0.03],
        "2_it_1": [0.04, 0.05, 0.06],
        "3_it_1": [0.07, 0.08, 0.09],
        "1_it_2": [0.1, 0.11, 0.12],
        "2_it_2": [0.13, 0.14, 0.15],
        "3_it_2": [0.16, 0.17, 0.18],
        "1_it_3_3": [0.19, 0.20, 0.21],
        "2_it_3_3": [0.22, 0.23, 0.24],
        "3_it_3_3": [0.25, 0.26, 0.27],
    ...
    assert (
        ...
        == np.array(
            [
                [
                    [0.01, 0.1, 0.19, 0.04, 0.13, 0.22],
                    [1.01, 1.1, 1.19, 1.04, 1.13, 1.22],
                ],
                [
                    [0.02, 0.11, 0.2, 0.05, 0.14, 0.23],
                    [1.02, 1.11, 1.2, 1.05, 1.14, 1.23],
                ],
                [
                    [0.03, 0.12, 0.21, 0.06, 0.15, 0.24],
                    [1.03, 1.12, 1.21, 1.06, 1.15, 1.24],
                ],
            ],
            dtype=np.float64,
        )
